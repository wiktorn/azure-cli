...
def load_arguments(self, _):
    ...
    with self.argument_context('kustotest cluster list') as c:
        c.argument('resource_group_name', resource_group_name_type)

    with self.argument_context('kustotest cluster show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')

    with self.argument_context('kustotest cluster create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.')
    ...
    with self.argument_context('kustotest cluster update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')
        c.argument('tags', tags_type)
    ...
    with self.argument_context('kustotest cluster delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')

    with self.argument_context('kustotest cluster add-language-extension') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')
        c.argument('value', action=AddClustersValue, nargs='*', help='The list of language extensions.')

    with self.argument_context('kustotest cluster detach-follower-database') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')
    ...
    with self.argument_context('kustotest cluster diagnose-virtual-network') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')

    with self.argument_context('kustotest cluster list-follower-database') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.')

    with self.argument_context('kustotest cluster list-language-extension') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.')

    with self.argument_context('kustotest cluster list-sku') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.')

    with self.argument_context('kustotest cluster remove-language-extension') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')
        c.argument('value', action=AddClustersValue, nargs='*', help='The list of language extensions.')

    with self.argument_context('kustotest cluster start') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')

    with self.argument_context('kustotest cluster stop') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')

    with self.argument_context('kustotest cluster wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', options_list=['--name', '-n', '--cluster-name'], type=str, help='The name of the '
                   'Kusto cluster.', id_part='name')

    with self.argument_context('kustotest cluster-principal-assignment list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')

    with self.argument_context('kustotest cluster-principal-assignment show') as c:
        c.argument('resource_group_name', resource_group_name_type)
    ...
    with self.argument_context('kustotest cluster-principal-assignment create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
    ...
    with self.argument_context('kustotest cluster-principal-assignment update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('principal_assignment_name', type=str, help='The name of the Kusto principalAssignment.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest cluster-principal-assignment delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('principal_assignment_name', type=str, help='The name of the Kusto principalAssignment.', id_part=''
                   'child_name_1')

    with self.argument_context('kustotest cluster-principal-assignment wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('principal_assignment_name', type=str, help='The name of the Kusto principalAssignment.', id_part=''
                   'child_name_1')

    with self.argument_context('kustotest database list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')

    with self.argument_context('kustotest database show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')

    with self.argument_context('kustotest database create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
    ...
    with self.argument_context('kustotest database update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest database delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')

    with self.argument_context('kustotest database add-principal') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest database list-principal') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')

    with self.argument_context('kustotest database remove-principal') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest database wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')

    with self.argument_context('kustotest database-principal-assignment list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')

    with self.argument_context('kustotest database-principal-assignment show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest database-principal-assignment create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')
        c.argument('principal_assignment_name', type=str, help='The name of the Kusto principalAssignment.')
    ...
    with self.argument_context('kustotest database-principal-assignment update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest database-principal-assignment delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest database-principal-assignment wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest attached-database-configuration list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')

    with self.argument_context('kustotest attached-database-configuration show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
    ...
    with self.argument_context('kustotest attached-database-configuration create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('attached_database_configuration_name', options_list=['--name', '-n', ''
                                                                         '--attached-database-configuration-name'],
    ...
    with self.argument_context('kustotest attached-database-configuration update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('attached_database_configuration_name', options_list=['--name', '-n', ''
                                                                         '--attached-database-configuration-name'],
    ...
    with self.argument_context('kustotest attached-database-configuration delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('attached_database_configuration_name', options_list=['--name', '-n', ''
                                                                         '--attached-database-configuration-name'],
    ...
    with self.argument_context('kustotest attached-database-configuration wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('attached_database_configuration_name', options_list=['--name', '-n', ''
                                                                         '--attached-database-configuration-name'],
    ...
    with self.argument_context('kustotest data-connection list') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')

    with self.argument_context('kustotest data-connection show') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest data-connection event-grid create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')
        c.argument('data_connection_name', options_list=['--name', '-n', '--data-connection-name'], type=str, help=''
    ...
    with self.argument_context('kustotest data-connection event-hub create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')
        c.argument('data_connection_name', options_list=['--name', '-n', '--data-connection-name'], type=str, help=''
    ...
    with self.argument_context('kustotest data-connection iot-hub create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.')
        c.argument('data_connection_name', options_list=['--name', '-n', '--data-connection-name'], type=str, help=''
    ...
    with self.argument_context('kustotest data-connection event-grid update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest data-connection event-hub update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest data-connection iot-hub update') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest data-connection delete') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
    ...
    with self.argument_context('kustotest data-connection data-connection-validation') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')

    with self.argument_context('kustotest data-connection wait') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('cluster_name', type=str, help='The name of the Kusto cluster.', id_part='name')
        c.argument('database_name', type=str, help='The name of the database in the Kusto cluster.', id_part=''
                   'child_name_1')
