...
def kustotest_cluster_list(client,
...
def kustotest_cluster_show(client,
                           resource_group_name,
                           cluster_name):
...
def kustotest_cluster_create(client,
                             resource_group_name,
                             cluster_name,
                             location,
                             sku,
...
def kustotest_cluster_update(client,
                             resource_group_name,
                             cluster_name,
                             tags=None,
                             location=None,
...
def kustotest_cluster_delete(client,
                             resource_group_name,
                             cluster_name,
                             no_wait=False):
    return sdk_no_wait(no_wait,
...
def kustotest_cluster_add_language_extension(client,
                                             resource_group_name,
                                             cluster_name,
                                             value=None,
                                             no_wait=False):
...
def kustotest_cluster_detach_follower_database(client,
                                               resource_group_name,
                                               cluster_name,
                                               cluster_resource_id,
...
def kustotest_cluster_diagnose_virtual_network(client,
                                               resource_group_name,
                                               cluster_name,
                                               no_wait=False):
    return sdk_no_wait(no_wait,
...
def kustotest_cluster_list_follower_database(client,
                                             resource_group_name,
                                             cluster_name):
...
def kustotest_cluster_list_language_extension(client,
                                              resource_group_name,
                                              cluster_name):
...
def kustotest_cluster_list_sku(client,
                               resource_group_name=None,
                               cluster_name=None):
...
def kustotest_cluster_remove_language_extension(client,
                                                resource_group_name,
                                                cluster_name,
                                                value=None,
                                                no_wait=False):
...
def kustotest_cluster_start(client,
                            resource_group_name,
                            cluster_name,
                            no_wait=False):
    return sdk_no_wait(no_wait,
...
def kustotest_cluster_stop(client,
                           resource_group_name,
                           cluster_name,
                           no_wait=False):
    return sdk_no_wait(no_wait,
...
def kustotest_cluster_principal_assignment_list(client,
                                                resource_group_name,
                                                cluster_name):
...
def kustotest_cluster_principal_assignment_show(client,
                                                resource_group_name,
                                                cluster_name,
...
def kustotest_cluster_principal_assignment_create(client,
                                                  resource_group_name,
                                                  cluster_name,
                                                  principal_assignment_name,
                                                  principal_id=None,
...
def kustotest_cluster_principal_assignment_update(client,
                                                  resource_group_name,
                                                  cluster_name,
                                                  principal_assignment_name,
                                                  principal_id=None,
...
def kustotest_cluster_principal_assignment_delete(client,
                                                  resource_group_name,
                                                  cluster_name,
                                                  principal_assignment_name,
                                                  no_wait=False):
...
def kustotest_database_list(client,
                            resource_group_name,
                            cluster_name):
...
def kustotest_database_show(client,
                            resource_group_name,
                            cluster_name,
                            database_name):
    return client.get(resource_group_name=resource_group_name,
...
def kustotest_database_create(client,
                              resource_group_name,
                              cluster_name,
                              database_name,
...
def kustotest_database_update(client,
                              resource_group_name,
                              cluster_name,
                              database_name,
                              read_write_database=None,
...
def kustotest_database_delete(client,
                              resource_group_name,
                              cluster_name,
                              database_name,
                              no_wait=False):
...
def kustotest_database_add_principal(client,
                                     resource_group_name,
                                     cluster_name,
                                     database_name,
                                     value=None):
...
def kustotest_database_list_principal(client,
                                      resource_group_name,
                                      cluster_name,
                                      database_name):
...
def kustotest_database_remove_principal(client,
                                        resource_group_name,
                                        cluster_name,
                                        database_name,
                                        value=None):
...
def kustotest_database_principal_assignment_list(client,
                                                 resource_group_name,
                                                 cluster_name,
                                                 database_name):
    return client.list(resource_group_name=resource_group_name,
...
def kustotest_database_principal_assignment_show(client,
                                                 resource_group_name,
                                                 cluster_name,
                                                 database_name,
                                                 principal_assignment_name):
...
def kustotest_database_principal_assignment_create(client,
                                                   resource_group_name,
                                                   cluster_name,
                                                   database_name,
                                                   principal_assignment_name,
...
def kustotest_database_principal_assignment_update(client,
                                                   resource_group_name,
                                                   cluster_name,
                                                   database_name,
                                                   principal_assignment_name,
...
def kustotest_database_principal_assignment_delete(client,
                                                   resource_group_name,
                                                   cluster_name,
                                                   database_name,
                                                   principal_assignment_name,
...
def kustotest_attached_database_configuration_list(client,
                                                   resource_group_name,
                                                   cluster_name):
    return client.list_by_cluster(resource_group_name=resource_group_name,
                                  cluster_name=cluster_name)
...
def kustotest_attached_database_configuration_show(client,
                                                   resource_group_name,
                                                   cluster_name,
                                                   attached_database_configuration_name):
    return client.get(resource_group_name=resource_group_name,
...
def kustotest_attached_database_configuration_create(client,
                                                     resource_group_name,
                                                     cluster_name,
                                                     attached_database_configuration_name,
                                                     location=None,
...
def kustotest_attached_database_configuration_update(client,
                                                     resource_group_name,
                                                     cluster_name,
                                                     attached_database_configuration_name,
                                                     location=None,
...
def kustotest_attached_database_configuration_delete(client,
                                                     resource_group_name,
                                                     cluster_name,
                                                     attached_database_configuration_name,
                                                     no_wait=False):
...
def kustotest_data_connection_list(client,
                                   resource_group_name,
                                   cluster_name,
                                   database_name):
...
def kustotest_data_connection_show(client,
                                   resource_group_name,
                                   cluster_name,
                                   database_name,
...
def kustotest_data_connection_event_grid_create(client,
                                                resource_group_name,
                                                cluster_name,
                                                database_name,
                                                data_connection_name,
...
def kustotest_data_connection_event_hub_create(client,
                                               resource_group_name,
                                               cluster_name,
                                               database_name,
                                               data_connection_name,
...
def kustotest_data_connection_iot_hub_create(client,
                                             resource_group_name,
                                             cluster_name,
                                             database_name,
                                             data_connection_name,
...
def kustotest_data_connection_event_grid_update(client,
                                                resource_group_name,
                                                cluster_name,
                                                database_name,
                                                data_connection_name,
...
def kustotest_data_connection_event_hub_update(client,
                                               resource_group_name,
                                               cluster_name,
                                               database_name,
                                               data_connection_name,
...
def kustotest_data_connection_iot_hub_update(client,
                                             resource_group_name,
                                             cluster_name,
                                             database_name,
                                             data_connection_name,
...
def kustotest_data_connection_delete(client,
                                     resource_group_name,
                                     cluster_name,
                                     database_name,
                                     data_connection_name,
...
def kustotest_data_connection_data_connection_validation(client,
                                                         resource_group_name,
                                                         cluster_name,
                                                         database_name,
                                                         no_wait=False):
    return sdk_no_wait(no_wait,
                       ...
                       properties=json.loads({"kind": "EventHub", "eventHubResourceId": "/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.EventHub/namespaces/eventhubTestns1/eventhubs/eventhubTest1", "consumerGroup": "testConsumerGroup1"}))
