...
### kustotest attached-database-configuration create

create a kustotest attached-database-configuration.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|kustotest attached-database-configuration|AttachedDatabaseConfigurations|
...
### kustotest attached-database-configuration delete

delete a kustotest attached-database-configuration.
...
### kustotest attached-database-configuration list

list a kustotest attached-database-configuration.
...
### kustotest attached-database-configuration show

show a kustotest attached-database-configuration.
...
### kustotest attached-database-configuration update

update a kustotest attached-database-configuration.
...
### kustotest cluster add-language-extension

add-language-extension a kustotest cluster.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|kustotest cluster|Clusters|
...
### kustotest cluster create

create a kustotest cluster.
...
### kustotest cluster delete

delete a kustotest cluster.
...
### kustotest cluster detach-follower-database

detach-follower-database a kustotest cluster.
...
### kustotest cluster diagnose-virtual-network

diagnose-virtual-network a kustotest cluster.
...
### kustotest cluster list

list a kustotest cluster.
...
### kustotest cluster list-follower-database

list-follower-database a kustotest cluster.
...
### kustotest cluster list-language-extension

list-language-extension a kustotest cluster.
...
### kustotest cluster list-sku

list-sku a kustotest cluster.
...
### kustotest cluster remove-language-extension

remove-language-extension a kustotest cluster.
...
### kustotest cluster show

show a kustotest cluster.
...
### kustotest cluster start

start a kustotest cluster.
...
### kustotest cluster stop

stop a kustotest cluster.
...
### kustotest cluster update

update a kustotest cluster.
...
### kustotest cluster-principal-assignment create

create a kustotest cluster-principal-assignment.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|kustotest cluster-principal-assignment|ClusterPrincipalAssignments|
...
### kustotest cluster-principal-assignment delete

delete a kustotest cluster-principal-assignment.
...
### kustotest cluster-principal-assignment list

list a kustotest cluster-principal-assignment.
...
### kustotest cluster-principal-assignment show

show a kustotest cluster-principal-assignment.
...
### kustotest cluster-principal-assignment update

update a kustotest cluster-principal-assignment.
...
### kustotest data-connection data-connection-validation

data-connection-validation a kustotest data-connection.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|kustotest data-connection|DataConnections|
...
### kustotest data-connection delete

delete a kustotest data-connection.
...
### kustotest data-connection event-grid create

event-grid create a kustotest data-connection.
...
### kustotest data-connection event-grid update

event-grid update a kustotest data-connection.
...
### kustotest data-connection event-hub create

event-hub create a kustotest data-connection.
...
### kustotest data-connection event-hub update

event-hub update a kustotest data-connection.
...
### kustotest data-connection iot-hub create

iot-hub create a kustotest data-connection.
...
### kustotest data-connection iot-hub update

iot-hub update a kustotest data-connection.
...
### kustotest data-connection list

list a kustotest data-connection.
...
### kustotest data-connection show

show a kustotest data-connection.
...
### kustotest database add-principal

add-principal a kustotest database.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|kustotest database|Databases|
...
### kustotest database create

create a kustotest database.
...
### kustotest database delete

delete a kustotest database.
...
### kustotest database list

list a kustotest database.
...
### kustotest database list-principal

list-principal a kustotest database.
...
### kustotest database remove-principal

remove-principal a kustotest database.
...
### kustotest database show

show a kustotest database.
...
### kustotest database update

update a kustotest database.
...
### kustotest database-principal-assignment create

create a kustotest database-principal-assignment.

#### Command group
|Name (az)|Swagger name|
|---------|------------|
|kustotest database-principal-assignment|DatabasePrincipalAssignments|
...
### kustotest database-principal-assignment delete

delete a kustotest database-principal-assignment.
...
### kustotest database-principal-assignment list

list a kustotest database-principal-assignment.
...
### kustotest database-principal-assignment show

show a kustotest database-principal-assignment.
...
### kustotest database-principal-assignment update

update a kustotest database-principal-assignment.
