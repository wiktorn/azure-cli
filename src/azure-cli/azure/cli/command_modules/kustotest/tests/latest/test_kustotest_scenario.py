...
def step_kustoclusterscreateorupdate(test, rg):
    test.cmd('az kustotest cluster create '
             '--name "{myCluster}" '
             ...
             '--resource-group "{rg}"',
             checks=[])
    test.cmd('az kustotest cluster wait --created '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodatabasescreateorupdate(test, rg):
    test.cmd('az kustotest database create '
...
def step_kustodataconnectionscreateorupdate(test, rg):
    test.cmd('az kustotest data-connection event-hub create '
             '--cluster-name "{myCluster}" '
...
def step_attacheddatabaseconfigurationscreateorupdate(test, rg):
    test.cmd('az kustotest attached-database-configuration create '
             ...
             '--resource-group "{rg}"',
             checks=[])
    test.cmd('az kustotest attached-database-configuration wait --created '
             '--name "{myAttachedDatabaseConfiguration2}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_attacheddatabaseconfigurationsget(test, rg):
    test.cmd('az kustotest attached-database-configuration show '
             '--name "{myAttachedDatabaseConfiguration2}" '
             '--cluster-name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodataconnectionsget(test, rg):
    test.cmd('az kustotest data-connection show '
             '--cluster-name "{myCluster}" '
             '--name "{myDataConnection}" '
             '--database-name "KustoDatabase8" '
             '--resource-group "{rg}"',
...
def step_kustodatabaseslistbycluster(test, rg):
    test.cmd('az kustotest database list '
             '--cluster-name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoattacheddatabaseconfigurationslistbycluster(test, rg):
    test.cmd('az kustotest attached-database-configuration list '
             '--cluster-name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodatabasesget(test, rg):
    test.cmd('az kustotest database show '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclusterslistresourceskus(test, rg):
    test.cmd('az kustotest cluster list-sku '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclustersget(test, rg):
    test.cmd('az kustotest cluster show '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclusterslistbyresourcegroup(test, rg):
    test.cmd('az kustotest cluster list '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodataconnectionsupdate(test, rg):
    test.cmd('az kustotest data-connection event-hub update '
             '--cluster-name "{myCluster}" '
             '--name "{myDataConnection}" '
             '--database-name "KustoDatabase8" '
             '--location "westus" '
...
def step_kustodataconnectionvalidation(test, rg):
    test.cmd('az kustotest data-connection data-connection-validation '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodatabaseremoveprincipals(test, rg):
    test.cmd('az kustotest database remove-principal '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
...
def step_kustodatabaselistprincipals(test, rg):
    test.cmd('az kustotest database list-principal '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodatabaseaddprincipals(test, rg):
    test.cmd('az kustotest database add-principal '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
             '--value name="Some User" type="User" app-id="" email="user@microsoft.com" fqn="aaduser role="Admin" '
             '--value name="Kusto" type="Group" app-id="" email="kusto@microsoft.com" fqn="aadgroup role="Viewer" '
...
def step_kustodatabasesupdate(test, rg):
    test.cmd('az kustotest database update '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
...
def step_kustoclusterdetachfollowerdatabases(test, rg):
    test.cmd('az kustotest cluster detach-follower-database '
             '--name "{myCluster}" '
...
def step_kustoclusterlistfollowerdatabases(test, rg):
    test.cmd('az kustotest cluster list-follower-database '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclustersstart(test, rg):
    test.cmd('az kustotest cluster start '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclustersstop(test, rg):
    test.cmd('az kustotest cluster stop '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclustersupdate(test, rg):
    test.cmd('az kustotest cluster update '
             '--name "{myCluster}" '
             '--identity-type "SystemAssigned" '
             '--location "westus" '
             '--enable-purge true '
...
def step_attacheddatabaseconfigurationsdelete(test, rg):
    test.cmd('az kustotest attached-database-configuration delete -y '
             '--name "{myAttachedDatabaseConfiguration2}" '
             '--cluster-name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodataconnectionsdelete(test, rg):
    test.cmd('az kustotest data-connection delete -y '
             '--cluster-name "{myCluster}" '
...
def step_kustodatabasesdelete(test, rg):
    test.cmd('az kustotest database delete -y '
             '--cluster-name "{myCluster}" '
             '--database-name "KustoDatabase8" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclustersdelete(test, rg):
    test.cmd('az kustotest cluster delete -y '
             '--name "{myCluster}" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustodatabaseprincipalassignmentsget(test, rg):
    test.cmd('az kustotest database-principal-assignment show '
             '--cluster-name "{myCluster}" '
             '--database-name "Kustodatabase8" '
...
def step_kustodatabaseprincipalassignmentscreateorupdate(test, rg):
    test.cmd('az kustotest database-principal-assignment create '
             '--cluster-name "{myCluster}" '
             '--database-name "Kustodatabase8" '
...
def step_kustodatabaseprincipalassignmentsdelete(test, rg):
    test.cmd('az kustotest database-principal-assignment delete -y '
             '--cluster-name "{myCluster}" '
             '--database-name "Kustodatabase8" '
             '--principal-assignment-name "kustoprincipal1" '
             '--resource-group "{rg}"',
...
def step_kustoclusterprincipalassignmentsget(test, rg):
    test.cmd('az kustotest cluster-principal-assignment show '
             '--cluster-name "{myCluster}" '
             '--principal-assignment-name "kustoprincipal1" '
             '--resource-group "{rg}"',
             checks=[])
...
def step_kustoclusterprincipalassignmentscreateorupdate(test, rg):
    test.cmd('az kustotest cluster-principal-assignment create '
             '--cluster-name "{myCluster}" '
             '--principal-id "87654321-1234-1234-1234-123456789123" '
             '--principal-type "App" '
...
def step_kustoclusterprincipalassignmentsdelete(test, rg):
    test.cmd('az kustotest cluster-principal-assignment delete -y '
             '--cluster-name "{myCluster}" '
             '--principal-assignment-name "kustoprincipal1" '
             '--resource-group "{rg}"',
             checks=[])
...
class KustoManagementClientScenarioTest(ScenarioTest):
    ...
    @ResourceGroupPreparer(name_prefix='clitestkustotest_kustorptest'[:7], key='rg', parameter_name='rg')
    def test_kustotest(self, rg):
