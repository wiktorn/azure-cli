...
class KustoManagementClientCommandsLoader(AzCommandsLoader):
    ...
    def __init__(self, cli_ctx=None):
        ...
        from .generated._client_factory import cf_kustotest_cl
        kustotest_custom = CliCommandType(
            operations_tmpl='azure.cli.command_modules.kustotest.custom#{}',
            client_factory=cf_kustotest_cl)
        parent = super(KustoManagementClientCommandsLoader, self)
        parent.__init__(cli_ctx=cli_ctx, custom_command_type=kustotest_custom)
